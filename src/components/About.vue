<template>
  <section class="about">
    ...
    <div class="about-content">
      ...
      <p>
        I specialize in front-end and back-end development, crafting user-friendly interfaces and scalable architectures. My expertise includes integrating cloud technologies like AWS and Docker to meet diverse business needs efficiently.
      </p>
      <p>
